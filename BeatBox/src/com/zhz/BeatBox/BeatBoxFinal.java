...
public class BeatBoxFinal {
	...
	JFrame theFrame;
	JPanel mainPanel;
	JList incomingList;									//receive the the selection
	JTextField userMessage;								//shows the user message
	...
	public void startUp(String name) {
		userName = name;	//open connection to the server
		try {
